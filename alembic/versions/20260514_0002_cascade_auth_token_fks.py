...
def downgrade() -> None:
    op.drop_constraint("password_reset_tokens_user_id_fkey", "password_reset_tokens", type_="foreignkey")
    op.create_foreign_key("password_reset_tokens_user_id_fkey", "password_reset_tokens", "users", ["user_id"], ["_id"])

    op.drop_constraint("email_verification_tokens_user_id_fkey", "email_verification_tokens", type_="foreignkey")
    op.create_foreign_key("email_verification_tokens_user_id_fkey", "email_verification_tokens", "users", ["user_id"], ["_id"])
