...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_user_two_factor_recovery_codes_code_hash",
        "user_two_factor_recovery_codes",
        ["code_hash"],
        unique=True,
    )
    op.create_index(
        "ix_user_two_factor_recovery_codes_is_used",
        "user_two_factor_recovery_codes",
        ["is_used"],
    )
    op.create_index(
        "ix_user_two_factor_recovery_codes_user_id",
        "user_two_factor_recovery_codes",
        ["user_id"],
    )
    op.create_index(
...
def downgrade() -> None:
    op.drop_index(
        "ix_user_two_factor_recovery_codes_user_unused",
        table_name="user_two_factor_recovery_codes",
    )
    op.drop_index(
        "ix_user_two_factor_recovery_codes_user_id",
        table_name="user_two_factor_recovery_codes",
